        ...
        <>
            ...
            <div className="overflow-hidden">
                    ...
                    <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                        ...
                        <div className="text-center">
                            ...
                            <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
                                AI and Machine Learning <p className="text-blue-500">Stock Price Prediction</p>
                            </h1>
                        </div>
                        {/* End Title */}
                            ...
                            <div className="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
                                ...
                                <div className="flex justify-center -space-x-3">
                                    ...
                                    <img
                                        ...
                                        alt="Image Description"/>
                                    <span
                                        className="inline-flex items-center justify-center h-8 w-8 rounded-full ring-2 ring-white bg-gray-800 dark:bg-gray-900 dark:ring-gray-800">
              <span className="text-xs font-medium leading-none text-white uppercase">7k+</span>
                            ...
                            <div
                                className="border-t sm:border-t-0 sm:border-s border-gray-200 w-32 h-px sm:w-auto sm:h-full mx-auto sm:mx-0"></div>

                            <div className="pt-5 sm:pt-0 sm:ps-5">
                                <div className="text-lg font-semibold text-gray-800 dark:text-gray-200">Trust pilot
                                </div>
                        ...
                        <div
                            ...
                            aria-hidden="true">
                            <svg className="w-52 h-auto" width="717" height="653" viewBox="0 0 717 653" fill="none"
                                ...
                                <path
                                    ...
                                    fill="currentColor" className="fill-orange-500"/>
                                <path
                                    ...
                                    fill="currentColor" className="fill-cyan-600"/>
                            </svg>
                        </div>
                        {/* End SVG Element */}
                        ...
                        <div
                            ...
                            aria-hidden="true">
                            <svg className="w-72 h-auto" width="1115" height="636" viewBox="0 0 1115 636" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
