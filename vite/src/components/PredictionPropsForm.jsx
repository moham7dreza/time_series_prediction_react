...
export const PredictionPropsForm = () => {
    ...
    const [datasetNames] = useFetch(config.api + 'datasets-name')
    const [modelsNames] = useFetch(config.api + 'models-name')
    const [seriesNames] = useFetch(config.api + 'series-name')
    const [pricesNames] = useFetch(config.api + 'prices-name')
    const [metricsNames] = useFetch(config.api + 'metrics-name')
    const [lastPredictionProps] = useFetch(config.api + 'last-predict-props')
